...
public class FingerCheck {
	...
	Map<Integer,FingerTable> createFingerTables(){
	...
	private void updateSuccessor(Map<Integer, FingerTable> fingerTables) {
	...
	private void updatePredecessor(Map<Integer, FingerTable> fingerTables) {
	...
	private void join(NodeID startNode, NodeID thisNode) {
		int i;
	...
	private void updateFingerTable(NodeID thisNode) {
		int i;
	...
	private void updateFingerComparison(NodeID checkNode, int index, NodeID thisNode) {
		String thisKey = thisNode.getId(); //node_new key i.e. key of current node
	...
	private void updateFinger(int index, NodeID thisNode, NodeID checkNode) {
	...
	private NodeID findSucc(String nextKey,NodeID startNode) {
	...
	private NodeID getNodeSucc(NodeID startNode) {
	...
	private NodeID findPred(String nextKey, NodeID startNode) {
	...
	private NodeID comparefingerTable(String nextKey,NodeID startNode) {
